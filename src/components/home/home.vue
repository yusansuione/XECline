    ...
    <div class="row1">
      <div class="commonWidth">
        <div class="commonTitle">
          <h3>欣依，不仅仅是一家新型公司</h3>
          <p>我们坚持我们的信仰，为用户打造真正视觉冲击的服务平台</p>
        </div>
...
import DataVisualization from "base/DataVisualization/DataVisualization";
import DesignVisualization from "base/DesignVisualization/DesignVisualization";
import DigitalPavilion from "base/DigitalPavilion/DigitalPavilion";
import InnovativeBusiness from "base/InnovativeBusiness/InnovativeBusiness";
import  MultimediaApplication from "base/MultimediaApplication/MultimediaApplication"
const ISHIDE = 8;
export default {
  name: "home",
  data() {
    return {
      ...
      scrollBanners_home: [require("@/components/home/1546239235065.png")],
      homeSliderData: [],
      goodProductList: [],
      initIndex: 0,
      recentNews: [],
