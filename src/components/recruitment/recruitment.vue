          ...
          <div class="content">
            <div class="box cf">
              ...
              <div class="fl campus-wrap">
                ...
                <ul>
                  <li v-for="item in campusRecruitment" :key="item.webWorkContentJob">
              ...
              <div class="fl social-wrap" style="margin:0 150px;">
                ...
                <ul>
                  <li v-for="item in societyRecruitment" :key="item.webWorkContentJob">
                        <span class="circle-wrap">
                            <i class=""></i>
                        </span>
                    <span class="desc" @click="select(item)">{{item.webWorkContentJob}}</span>
              ...
              <div class="fl welfare-wrap">
                ...
                <ul>
                  <li v-for="item in Benefits" :key="item.webWorkContentJob">
                        <span class="circle-wrap">
                            <i class=""></i>
                        </span>
                    <span class="desc" @click="select(item)">{{item.webWorkContentJob}}</span>
